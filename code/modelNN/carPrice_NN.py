...
#Load dataset car
df_cars= pd.read_csv("/tmp/AI-CPS/data/joint_data_collection.csv")
...
# Save to CSV files
train_data.to_csv("/tmp/AI-CPS/data/train/training_data.csv", index=False)
test_data.to_csv("/tmp/AI-CPS/data/validation/test_data.csv", index=False)
...
select_row(test_data, "/tmp/AI-CPS/data/activationBase/activation_data.csv")
...
model.save("/tmp/AI-CPS/data/learningBase_NN/currentAiSolution.h5")

y_pred_nn = model.predict(X_test).flatten()

# ############################################# Plots #########################################
with PdfPages("/tmp/AI-CPS/documentation/NN_Model_Plots.pdf") as pdf:
